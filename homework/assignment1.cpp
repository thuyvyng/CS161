...
int main() {
	...
	cout << "Log of 55 with base 10 is " << logz << endl;

	float natlog = log(60);
	cout << "Natural log of 60 is " << natlog << endl << endl;

	cout << "Find the log base of 2 of 15" << endl;
	...
	cout << "ln(2) = " << nl2 << endl;
	cout << "ln(15)/ln(2) = " << logz1 << endl << endl;

	cout << "Find the log base of 4 of 40" << endl;

	cout << "ln(40) = " << nl40 << endl;
	cout << "ln(4) = " << nl4 << endl;
	cout << "ln(40)/ln(4) = " << logz2 << endl << endl;
// Above this everything works!!!
//
//
//
//
...
//
	...
	cout << endl << "Solving 3 to the sin(x) " << endl << endl;
	int loop;
	double num, result;
	...
	cout << " (1)^2 + 1 = " << eq1 << endl;
	cout << " log2(x^2 +1) = ln (1^2 +1)/ ln(2) = " << log2(eq1)  << endl << endl ;
...
//	eq2 = 10^2 +1;
	...
	cout << "log2(x^2+1) = ln(10^2 +1)/(ln2) =  " << ahh << endl;
